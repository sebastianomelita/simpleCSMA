...
Si può usare per realizzare un sistema multimaster con stazioni che trasmettono indipendentemente una dall'altra senza la supervisione di un dispositivo centrale (master).
